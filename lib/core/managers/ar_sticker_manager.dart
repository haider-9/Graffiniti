...
class ARStickerManager extends ChangeNotifier {
  ...
  void onPanUpdate(DragUpdateDetails details) {
    if (_isDragging && _selectedSticker != null && _editingStickerId != null) {
      // Convert screen delta to world delta (simplified)
      final worldDelta = _screenToWorldDelta(details.delta);
